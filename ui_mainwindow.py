...
#
# Created: Fri Mar 25 18:30:53 2011
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.helplabel.setText(_fromUtf8(""))
        self.helplabel.setObjectName(_fromUtf8("helplabel"))
        self.horizontalLayout.addWidget(self.helplabel)
        self.showHelpButton = QtGui.QPushButton(self.centralwidget)
        self.showHelpButton.setObjectName(_fromUtf8("showHelpButton"))
        self.horizontalLayout.addWidget(self.showHelpButton)
        self.ignoreButton = QtGui.QPushButton(self.centralwidget)
        ...
        self.actionStandard_Help = QtGui.QAction(MainWindow)
        self.actionStandard_Help.setObjectName(_fromUtf8("actionStandard_Help"))
        self.actionNetwork_Help = QtGui.QAction(MainWindow)
        self.actionNetwork_Help.setObjectName(_fromUtf8("actionNetwork_Help"))
        ...
        self.menuHelp.addAction(self.actionStandard_Help)
        self.menuHelp.addAction(self.actionNetwork_Help)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.showHelpButton.setText(QtGui.QApplication.translate("MainWindow", "Show Help", None, QtGui.QApplication.UnicodeUTF8))
        self.ignoreButton.setText(QtGui.QApplication.translate("MainWindow", "Ignore", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionStandard_Help.setText(QtGui.QApplication.translate("MainWindow", "Standard Help", None, QtGui.QApplication.UnicodeUTF8))
        self.actionNetwork_Help.setText(QtGui.QApplication.translate("MainWindow", "Network Help", None, QtGui.QApplication.UnicodeUTF8))
